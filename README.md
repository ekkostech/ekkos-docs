...
This repository contains the **official, canonical documentation** for ekkOS — the intelligence layer for AI development.
...
ekkOS is the intelligence layer under your AI coding tools. It remembers what worked, blocks what failed, enforces your rules, and compounds knowledge across every session, every tool, and every project.
